    ...
    def enhance(self, raw_prompt, purpose, model_format, aesthetic, precision,
        ...
        while quality_issues and quality_retries < max_quality_retries:
            ...
            repair_sys_prompt = sys_prompt + (
                ...
                f"The selected length is {length_target}. The completed positive prompt MUST reach at least "
        ...
        # Short/Medium may return the best clean draft with a soft warning.
        # Long/Max Detail are strict: after dedicated expansion retries, an
        # under-length result is rejected rather than silently violating the dropdown.
        fatal_quality_issues = [
            ...
            if (
                ...
                or (
                    length_target in ("Long", "Max Detail")
                    and "under-length" in issue.lower()
                )
            )
        ]
