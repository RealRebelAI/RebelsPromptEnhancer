...
- **Two Model Families:**USE QWEN! **MiniCPM5-1B is CURRENTLY OUT OF ORDER** Pick **Qwen3.5-4B** (much better instruction following, multimodal-capable model used text-only here).
